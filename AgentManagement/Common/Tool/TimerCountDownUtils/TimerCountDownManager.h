...
@class CountdownTask;
@interface TimerCountDownManager : NSObject
 ...
 */
- (BOOL)countdownTaskExistWithKey:(NSString *)akey task:(CountdownTask * _Nullable * _Nullable)task;
